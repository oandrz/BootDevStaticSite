...
<body>
    ...
    <p>This is a test page generated by the write_html_to_file function.</p>
</body>
</html>"""
    
    test_success = write_html_to_file(test_html, "../public/test.html")
    if test_success:
        print("Successfully wrote test HTML file")
    else:
        print("Failed to write test HTML file") 